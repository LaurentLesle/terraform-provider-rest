...
page_title: "rest_resource Data Source - terraform-provider-rest"
subcategory: ""
description: |-
  `rest_resource` data source can be used to retrieve the model of a rest resource by ID.
---

# rest_resource (Data Source)
