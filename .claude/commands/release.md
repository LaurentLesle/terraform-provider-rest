---
description: Create a new Terraform provider release with automatic semver tagging
allowed-tools: Bash(git describe:*), Bash(git log:*), Bash(git diff:*), Bash(git tag:*), Bash(git push:*), Bash(git branch:*)
---
